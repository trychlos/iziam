        ...
        en: {
            ...
            clients: {
                checks: {
                    ...
                    home_unset: 'The home URL is not set',
                    ...
                    logo_unset: 'The logo URL is not set',
                    logouts_unset: 'No logout redirection URL is set',
                    ...
                    privacy_unset: 'The privacy policy URL is not set',
                    ...
                    tos_unset: 'The terms of service URL is not set'
                },
                contacts: {
            ...
            groups: {
                ...
                edit: {
                    ...
                    client_dialog_title: 'Editing the "%s" clients group',
                    clients_groups_dialog_title: 'Editing the clients groups hierarchy',
                    ...
                    identities_groups_dialog_title: 'Editing the identities groups hierarchy',
                    identity_dialog_title: 'Editing the "%s" identities group',
                    label_label: 'Label :',
            ...
            organizations: {
                ...
                checks: {
                    ...
                    authorization_level: 'The authorization endpoint has empty path level(s)',
                    authorization_short: 'The authorization endpoint is too short',
                    ...
                    end_session_level: 'The end session endpoint has empty path level(s)',
                    end_session_short: 'The end session endpoint is too short',
                    ...
                    introspection_level: 'The introspection endpoint has empty path level(s)',
                    introspection_short: 'The introspection endpoint is too short',
                    ...
                    jwks_unset: 'No JSON Web Key Set is defined',
                    jwks_uri_absolute: 'The JWKS URL must be provided as an absolute path',
                    jwks_uri_exists: 'The JWKS path is already registered for "%s"',
                    jwks_uri_level: 'The JWKS URL has empty path level(s)',
                    jwks_uri_short: 'The JWKS URL is too short',
                    ...
                    registration_absolute: 'The dynamic registration endpoint must be provided as an absolute path',
                    registration_exists: 'The dynamic registration endpoint is already registered for "%s"',
                    registration_level: 'The dynamic registration endpoint has empty path level(s)',
                    registration_short: 'The dynamic registration endpoint is too short',
                    registration_unset: 'The dynamic registration endpoint is not set',
                    ...
                    revocation_level: 'The revocation endpoint has empty path level(s)',
                    revocation_short: 'The revocation endpoint is too short',
                    ...
                    token_level: 'The token endpoint has empty path level(s)',
                    token_short: 'The token endpoint is too short',
                    ...
                    userinfo_exists: 'The userinfo endpoint is already registered for "%s"',
                    userinfo_level: 'The userinfo endpoint has empty path level(s)',
                    userinfo_short: 'The userinfo endpoint is too short',
