...
import '/imports/client/components/client_status_pane/client_status_pane.js';
...
Template.client_edit_dialog.onCreated( function(){
    ...
    self.APP.tabbed.setTabbedParms({
        tabs: [
            ...
            {
                name: 'client_groups_tab',
                navLabel: pwixI18n.label( I18N, 'clients.edit.groups_tab_title' ),
                paneTemplate: 'client_groups_pane',
                paneData: paneData
            },
            {
