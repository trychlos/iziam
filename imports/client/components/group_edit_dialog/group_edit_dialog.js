...
Template.group_edit_dialog.events({
    ...
    'iz-submit .c-group-edit-dialog'( event, instance ){
        ...
        Meteor.callAsync( 'groups.upsert', item )
            .then(() => {
                Tolert.success( pwixI18n.label( I18N, instance.APP.isNew.get() ? 'groups.edit.new_success' : 'groups.edit.edit_success', item.label ));
