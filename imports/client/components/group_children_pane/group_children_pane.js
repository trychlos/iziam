/*
 * /imports/client/components/group_children_pane/group_children_pane.js
 *
...
import './group_children_pane.html';

Template.group_children_pane.onCreated( function(){
    const self = this;
    //console.debug( this );
...
Template.group_children_pane.onRendered( function(){
    const self = this;
...
Template.group_children_pane.helpers({
    // string translation
    i18n( arg ){
...
Template.group_children_pane.events({
